              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                <thead className="thead-light">
                  <tr>
                    ...
                    <th>Usage</th>
                    <th className="text-center color-bg">Payment Method</th>
                    <th>Activity</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={img1} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={img2} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={img3} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={img4} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-success"></span>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={img5} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-danger"></span>
                      </div>
                    </td>
                    <td>
